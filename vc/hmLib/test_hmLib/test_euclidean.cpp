...
public:
	TEST_METHOD(construct){
		euclidean::element<double, 4> Element(0.0);
	...
	TEST_METHOD(construct_value){
		euclidean::element<double, 4> Element(0.4);
	...
	TEST_METHOD(construct_initialize_list){
		euclidean::element<double, 4> Element = {4.0,5.0,6.0,7.0};
	...
	TEST_METHOD(add){
		euclidean::element<double, 3> e1{1.2,2.4,3.6};
		euclidean::element<double, 3> e2{1.0,1.0,1.0};
