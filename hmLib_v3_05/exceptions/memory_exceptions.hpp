...
namespace hmLib{
	namespace exceptions{
		...
		//メモリ割り当てに失敗した場合
		class fail_allocation:public bad_exception,public memory_exception{
		...
		//メモリ解放に失敗した場合
		class fail_deallocation:public bad_exception,public memory_exception{
			typedef exception excp_type;
			typedef bad_exception base_type;
		public:
		...
		//動的キャストに失敗した場合
		class incorrect_downcast_request:public bad_exception,public memory_exception{
			typedef exception excp_type;
			typedef bad_exception base_type;
		public:
