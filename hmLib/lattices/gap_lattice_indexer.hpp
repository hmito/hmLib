...
#
//!@brief Definition of the gap_lattice_indexer
...
namespace hmLib{
	namespace lattices{
		...
		@attention Because of the consideration of gaps, The performance of gap_lattice_indexer is less than that of lattice_indexer.
		@sa lattice_indexer
		*/
		...
		public:
			gap_lattice_indexer() : Size(0), Gap(0), Lower(){}
			template<typename... others>
			gap_lattice_indexer(size_type  Size_, others... Others) : Size(Size_), Gap(0), Lower(Others...){
				static_assert(sizeof...(others)+1 == dim_, "The argument number is different from the dim number");
			}
			template<typename... others>
			gap_lattice_indexer(std::pair<size_type, index_type>  SizeGap_, others... Others) : Size(SizeGap_.first), Gap(SizeGap_.second), Lower(Others...) {
				static_assert(sizeof...(others)+1 == dim_, "The argument number is different from the dim number");
			}
		public:
