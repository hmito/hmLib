...
namespace hmLib{
	namespace lattices{
		...
		public:
			...
			basic_iterator(lattice& Lattice_, index_type SeqNo_) :pLattice(&Lattice_), SeqNo(SeqNo_){}
		public:
		...
		public:
			...
			this_type& operator+=(index_type Dif_){ SeqNo += Dif_; return *this; }
			...
			this_type& operator-=(index_type Dif){ SeqNo -= Dif; return *this;}
			friend this_type operator-(const this_type& Loc, diff_type Dif){
				auto Ans(Loc);
				Ans -= Dif;
				return Ans;
		...
		public:
			...
			this_type& operator=(this_type&&) = default;
			basic_const_iterator(const lattice& Lattice_, index_type SeqNo_) :pLattice(&Lattice_), SeqNo(SeqNo_){}
		...
		public:
			...
			this_type& operator+=(index_type Dif_){ SeqNo += Dif_; return *this; }
			friend this_type operator+(const index_type& Loc, index_type Dif){
				auto Ans(Loc);
				Ans += Dif;
				return Ans;
			}
			friend this_type operator+(index_type Dif, const this_type& Loc){ return operator+(Loc, Dif); }
			this_type& operator-=(index_type Dif){ SeqNo -= Dif; return *this; }
			friend this_type operator-(const this_type& Loc, index_type Dif){
				auto Ans(Loc);
				Ans -= Dif;
				return Ans;
			}
